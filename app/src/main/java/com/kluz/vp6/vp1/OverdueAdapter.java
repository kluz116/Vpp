...
public class OverdueAdapter extends RecyclerView.Adapter<OverdueAdapter.MyViewHolder> {
    ...
    public OverdueAdapter(Context mContext, List<Warning> ListOfClients) {
        this.mContext = mContext;
        this.ListOfClients = ListOfClients;
    }

    @Override
    public OverdueAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.overdue_card, parent, false);

        return new OverdueAdapter.MyViewHolder(itemView);
    }



    @Override
    public void onBindViewHolder(final OverdueAdapter.MyViewHolder holder, int position) {

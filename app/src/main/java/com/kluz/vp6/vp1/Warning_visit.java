...
public class Warning_visit extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getSerializableExtra("client")!=null) {
            ...
            if(CheckNetwork.isInternetAvailable(Warning_visit.this)) //returns true if internet available
            {
                Clients(sp);
    ...
    private void Clients(final String sp) {
        ...
        String url = "http://villagepower.info/vpc/warning_app_v1.php";
        StringRequest arrayreq = new StringRequest(Request.Method.POST, url,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (got_id ==R.id.nav_sign_out) {
            ...
            Intent i = new Intent(Warning_visit.this,ChangePassword.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (item_id == R.id.nav_gallery) {
            ...
            Intent intent = new Intent(Warning_visit.this, Sales.class);
            ...
            Intent intent = new Intent(Warning_visit.this, MainActivity.class);
            intent.putExtra("vpc", vpc);
            intent.putExtra("sales_person", sales_person);
            intent.putExtra("id",id );
            startActivity(intent);
            ...
            Intent intent = new Intent(Warning_visit.this, PendingVisit.class);
            intent.putExtra("vpc", vpc);
            intent.putExtra("sales_person", sales_person);
            intent.putExtra("id",id );
            startActivity(intent);
            ...
            Intent intent = new Intent(Warning_visit.this, Anaylsis.class);
            intent.putExtra("vpc", vpc);
            intent.putExtra("sales_person", sales_person);
            intent.putExtra("id",id );
            startActivity(intent);
            ...
            Intent intent = new Intent(Warning_visit.this, com.kluz.vp6.vp1.Menu.class);
            intent.putExtra("vpc", vpc);
            intent.putExtra("sales_person", sales_person);
            intent.putExtra("id",id );
            startActivity(intent);

...
public class PreviousAdapter extends RecyclerView.Adapter<PreviousAdapter.MyViewHolder> {
    ...
    public PreviousAdapter(Context mContext, List<Sales_model> ListOfClients) {
        this.mContext = mContext;
        this.ListOfClients = ListOfClients;
    }

    @Override
    public PreviousAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.previous_card, parent, false);

        return new PreviousAdapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(final PreviousAdapter.MyViewHolder holder, int position) {
